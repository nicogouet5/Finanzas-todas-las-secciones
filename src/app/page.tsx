...
import { HubStatCounter } from "@/components/hub-stat-counter";
...
export default async function Home() {
  ...
  return <><AsciiBackground /><main id="main" className="page home"><section className="home-hero" aria-labelledby="hub-title"><p className="eyebrow">// HUB_01 <span>Universidad del Desarrollo</span></p><h1 id="hub-title">Hub de Finanzas</h1><p className="lede">Materiales de estudio, visores y descargas para tus ramos.</p></section><dl className="hub-stats" aria-label="Estado del Hub"><div><dt><HubStatCounter value={stats.courseCount} padStart={2} /></dt><dd>ramos activos</dd></div><div><dt><HubStatCounter value={stats.moduleCount} /></dt><dd>módulos</dd></div><div><dt><HubStatCounter value={stats.fileCount} /></dt><dd>archivos</dd></div><div><dt>{stats.latestLabel}</dt><dd>última subida</dd></div></dl><RecentMaterials courseModules={courseModules} materials={materials} uploadedAtByPath={uploadedAtByPath} /><section className="course-directory" aria-labelledby="course-index-title"><header><p className="section-kicker">// DIRECTORY_01</p><h2 id="course-index-title">Elige tu ramo.</h2><p>Accede a las carpetas, guías y presentaciones disponibles.</p></header><div className="course-grid" aria-label="Ramos"><Link className="course-card course-card--directory" href="/ramos/finanzas"><span className="course-card__number">01</span><div><p className="course-card__label">Ramo activo</p><h3 className="course-card__title"><ContentIcon kind="course" />Finanzas</h3><p>Administración de caja y certámenes.</p></div><strong className="course-card__cta">Explorar <span aria-hidden="true">↗</span></strong></Link><Link className="course-card course-card--directory" href="/ramos/finanzas-corporativas"><span className="course-card__number">02</span><div><p className="course-card__label">Ramo activo</p><h3 className="course-card__title"><ContentIcon kind="course" />Finanzas Corporativas</h3><p>Módulos y materiales disponibles.</p></div><strong className="course-card__cta">Ver ramo <span aria-hidden="true">↗</span></strong></Link></div></section></main></>;
}
